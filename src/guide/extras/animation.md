...
// Uwaga: Dla wartości większych niż Number.MAX_SAFE_INTEGER (9007199254740991),
// rezultat może być niedokładny w wyniku ograniczeń precyzji numerycznych JavaScript.
watch(number, (n) => {
